...
[![Build Status](https://travis-ci.org/jeremykenedy/domain-controller.svg?branch=master)](https://travis-ci.org/jeremykenedy/domain-controller)
[![StyleCI](https://styleci.io/repos/44714043/shield?branch=master)](https://styleci.io/repos/44714043)
[![Build Status](https://scrutinizer-ci.com/g/jeremykenedy/domain-controller/badges/build.png?b=master)](https://scrutinizer-ci.com/g/jeremykenedy/domain-controller/build-status/master)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/jeremykenedy/domain-controller/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/jeremykenedy/domain-controller/?branch=master)
[![Code Intelligence Status](https://scrutinizer-ci.com/g/jeremykenedy/domain-controller/badges/code-intelligence.svg?b=master)](https://scrutinizer-ci.com/code-intelligence)
[![All Contributors](https://img.shields.io/badge/all_contributors-23-orange.svg?style=flat-square)](#contributors)
[![MadeWithLaravel.com shield](https://madewithlaravel.com/storage/repo-shields/1342-shield.svg)](https://madewithlaravel.com/p/domain-controller/shield-link)
...
<table>
    <tr>
        ...
        <td>
            If you want to quickly add secure token-based authentication to Laravel apps, feel free to check Auth0's Laravel SDK and free plan at <a href="https://auth0.com/developers?utm_source=GHsponsor&utm_medium=GHsponsor&utm_campaign=domain-controller&utm_content=auth" target="_blank">https://auth0.com/developers</a>.
        </td>
    </tr>
</table>
...
- [Laravel Auth License](#domain-controller-license)
...
1. Run `git clone https://github.com/jeremykenedy/domain-controller.git domain-controller`
...
```
7. From the projects root folder run `sudo chmod -R 755 ../domain-controller`
...
##### Themes Seed List
  * [ThemesTableSeeder](https://github.com/jeremykenedy/domain-controller/blob/master/database/seeds/ThemesTableSeeder.php)
...
##### Blocked Types Seed List
  * [BlockedTypeTableSeeder.php](https://github.com/jeremykenedy/domain-controller/blob/master/database/seeds/BlockedTypeTableSeeder.php)
...
##### Blocked Items Seed List
  * [BlockedItemsTableSeeder.php](https://github.com/jeremykenedy/domain-controller/blob/master/database/seeds/BlockedItemsTableSeeder.php)
...
###### Updates:
* Update to Laravel 8
* Update to Laravel 7 [See changes in this PR](https://github.com/jeremykenedy/domain-controller/pull/348/files)
* Update to Laravel 6
...
### Screenshots
![Login](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/1domain-controller2-login.jpg)
![Register](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/2domain-controller2-register.jpg)
![Registration Confirmation](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/3domain-controller2-account-req-activation.jpg)
![Registration Email](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/4domain-controller2-activation-email.jpg)
![Registration Complete](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/5domain-controller2-userhome-with-flash-success.jpg)
![Intial User Profile](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/6domain-controller2-profile-mapless.jpg)
![Edit User Profile](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/7domain-controller2-profile-edit.jpg)
![Find Location Using Google Maps API v3](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/8domain-controller2-edit-profile-lookup.jpg)
![Profile Updated](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/9domain-controller2-flash-success.jpg)
![Profile Semi-completed](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/10domain-controller2-profile-with-map.jpg)

![Admin Panel Users List](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/11domain-controller2-users-list.jpg)
![Admin Panel Delete User](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/12domain-controller2-modal-delete.jpg)
![Admin Panel Flash Error](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/13domain-controller2-flash-error.jpg)
![Admin Panel Show User](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/14domain-controller2-show-edit.jpg)
![Admin Panel Edit User](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/15domain-controller2-edit-user.jpg)
![Admin Panel Save Edits](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/16domain-controller2-modal-save.jpg)
![Admin Panel Create User](https://s3-us-west-2.amazonaws.com/github-project-images/domain-controller/17domain-controller-create-user.jpg)
...
domain-controller is licensed under the [MIT license](https://opensource.org/licenses/MIT). Enjoy!

### Contributors
* Thanks goes to these [wonderful people](https://github.com/jeremykenedy/domain-controller/graphs/contributors):
